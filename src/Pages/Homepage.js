...
function Homepage() {
  ...
  axios.get(`https://prosmedia.online/api/profileImage/${id}`).then((response)=>{
  ...
  useEffect(()=>{
    ...
    axios.get(`https://prosmedia.online/api/profileImage/${user.id}`).then((response)=>{
      if(response.data.dp){
    ...
    axios.get('https://prosmedia.online/api/post').then((response)=>{
          setPostLoop(response.data)
    })
    axios.get(`https://prosmedia.online/api/follow/${user.id}`).then((response)=>{
  ...
  const handleFollow = (id)=>{
    ...
    axios.post(`https://prosmedia.online/api/follow_check/${user.id}`,{
      acc_uid:user.id,
      f_uid:id
    }).then((response)=>{
  ...
  const handleUnfollow = (id)=>{
    axios.delete(`https://prosmedia.online/api/unfollow/${id}/${user.id}`).then((response)=>{
      // console.log('success')
      setFollow(response.data)
    })
  }
